...
class Constants(BaseConstants):
    ...
    task_4_find = [417, 860, 758, 961, 197, 260, 978, 775, 170, 233, 213, 195, 780, 966, 205, 245, 548, 661, 835, 955,
                   458, 914, 356, 551, 465, 556, 603, 527, 481, 799, 377, 687, 923, 757, 727, 446, 651, 249, 206, 181,
                   281, 644, 632, 666, 591, 281, 738, 569, 951, 433, 701, 645, 251, 301, 978, 274, 179, 422, 791, 960]
...
class Subsession(BaseSubsession):
    def creating_session(self):
        if self.round_number == 1:
            path = os.getcwd() + "/_static/global/matrix_ass4.json"
            jsonfile = open(path)
            self.session.vars['task_4_nums'] = json.loads(jsonfile.read())
...
class Player(BasePlayer):
    ...
    def compute_score(self):
        ...
        current_constant = Constants.task_4_find[self.round_number - 1]
        for index, num in enumerate(self.session.vars['task_4_nums'][str(self.round_number)]):
